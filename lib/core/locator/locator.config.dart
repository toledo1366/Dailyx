...
import 'package:dailyx/domain/repositories/diary/diary_repository.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i4.DiaryRepository>(() => _i4.DiaryRepositoryImplementation());
    gh.factory<_i5.GetDiaryListUseCase>(
        () => _i5.GetDiaryListUseCase(gh<_i4.DiaryRepository>()));
    ...
    gh.factory<_i8.AddNewDiaryEntryUseCase>(
        () => _i8.AddNewDiaryEntryUseCase(gh<_i4.DiaryRepository>()));
    gh.factory<_i9.DiaryListCubit>(() => _i9.DiaryListCubit(
          gh<_i5.GetDiaryListUseCase>(),
